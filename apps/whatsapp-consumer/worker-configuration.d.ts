/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 73fb64fd4d40e909ca5d4876df9ebf19)
// Runtime types generated with workerd@1.20260701.1 2026-07-06 nodejs_compat
interface __BaseEnv_Env {
	CONNECTOR_DB: D1Database;
	ENVIRONMENT: "local";
	META_GRAPH_API_VERSION: "v25.0";
	META_ACCESS_TOKEN_LOCAL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "META_GRAPH_API_VERSION" | "META_ACCESS_TOKEN_LOCAL">> {}
}
