...
const tokenGroups = [
  {
    ...
    tokens: [
      ...
      { className: "bg-signal-faded", name: "signal-faded", value: "bg-signal-faded" },
    ],
  },
  {
    title: "Brand",
    ...
    <main className="min-h-screen bg-page text-ink-body">
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-8 lg:grid-cols-[minmax(0,1fr)_26rem] lg:items-end">
          <div className="max-w-4xl" data-reveal>
            ...
            <p className="mt-5 max-w-3xl text-base leading-7 text-ink-body sm:text-lg">
              This route documents the live TailorOS token contract, owned
              primitives, business UI examples, motion timing, state rules, and
              edge cases derived from the product PRDs and Cloudflare stack
              guide.
            </p>
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[15rem_minmax(0,1fr)] lg:px-8">
        <aside className="hidden lg:block">
          <nav className="sticky top-24 grid gap-1" aria-label="Design system sections">
            {navItems.map((item) => (
              <a
        ...
        <div className="grid gap-10">
            ...
            <div className="grid gap-4 lg:grid-cols-[1fr_18rem]">
              <div className="rounded-xl border border-hairline bg-surface p-5">
                ...
                <p className="mt-4 max-w-2xl text-base leading-7 text-ink-body">
                  Use direct labels, visible IDs, dates, balances, and status
                  changes. Avoid long prose inside repeated workflow screens.
                </p>
              </div>
              <div className="rounded-xl border border-hairline bg-surface p-5">
                <p className="text-xs font-semibold uppercase tracking-wide text-ink-muted">
              ...
              <PreviewPanel title="Fields and search">
                <div className="grid gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="customer-name" defaultValue="Meena Ravi" />
                  </div>
                  <div className="grid gap-2">
                ...
                <div className="flex flex-wrap gap-3">
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Payment is recorded. Receipt sharing can run through
                          TailorOS now and WhatsApp Connector later.
                        </DialogDescription>
                      </DialogHeader>
                      <ReceiptPreview
                        balanceDue={1800}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuPopup>
                      ...
                      <DropdownMenuItem disabled>Send marketing</DropdownMenuItem>
                    </DropdownMenuPopup>
                  </DropdownMenu>
                </div>
              </PreviewPanel>
              ...
              <PreviewPanel title="Loading and empty states">
                <div className="grid gap-3">
                  ...
                  <Callout variant="warning">
                    No exact customer match. Check family profiles before
            ...
            <div className="grid gap-5 xl:grid-cols-[1fr_0.9fr]">
              <div className="grid gap-4">
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  <MeasurementField label="Chest" unit="in" value="36.5" />
                  <MeasurementField
                    label="Sleeve"
                  ...
                  />
                  <MeasurementField label="Length" unit="in" value="28.0" />
                </div>
          ...
          >
            ...
            <Callout className="mt-5" variant="info">
              `SmoothScrollProvider`, `AnimationProvider`, route templates,
              buttons, dialogs, and dropdowns all respect reduced-motion
              preference and keep animations to opacity or transform.
            </Callout>
          </ReferenceSection>
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ["TanStack Query", "Server state only: search, orders, customers, messages, reports."],
                ["Zustand", "Local UI only: command palette, selected row, drawer state, drafts."],
                ["React Hook Form + Zod", "Fast client validation with trusted server validation at the boundary."],
                ["Optimistic updates", "Safe for status changes, never for payment totals without reconciliation."],
              ].map(([title, body]) => (
                <div
                  className="rounded-xl border border-hairline bg-surface p-4 shadow-sm"
                  key={title}
...
function ColorToken({ className, name, value }: ColorTokenProps) {
  return (
    <div className="rounded-xl border border-hairline bg-surface p-3 shadow-sm">
      <div className={cn("h-16 rounded-lg border border-hairline", className)} />
      <div className="mt-3 flex items-center justify-between gap-3">
        <strong className="truncate text-sm text-ink-display">{name}</strong>
